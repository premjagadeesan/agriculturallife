	...
	<div id="contents">
		<div class="clearfix">	
			...
			<div id="contents" style='background:#ffffff;padding-left:20px;padding-right:20px;padding-top:20px;padding-bottom:20px;' >
					...
					print '<hr>';
					 Print "<span>".$info['contents'] . "</span><br><br><br>";
					...
					print '<form style="padding-top:20px;"  id="exm1" method="post" action="comment.php?to_id='.$inputno.'">';
					?>
					<ul>
					
					<h2  style="color:#ff9900;font-size:30px;font-weight: bold;"> Leave a Comment </h2><br>
					<li><label style="color: #006699;font-size: 20px;text-transform: capitalize;font-weight: bold;"	>Name:</label><input type="text" id="name" name="name" style="width:330px;"  data-validetta="required,minLength[2],maxLength[30]" class="txtinput" /></li>				 
					<li><label style="color: #006699;font-size: 20px;text-transform: capitalize;font-weight: bold;" >Email:</label><input type="text" id="email" name="emailid" style="width:330px;"   data-validetta="email,required" class="txtinput" /></li>        
					<li><label style="color: #006699;font-size: 20px;text-transform: capitalize;font-weight: bold;" >Comments:</label><textarea name="contents" style="width:350px;"  class="jqte-test" ></textarea></li>
					...
					<li><input type="submit" value="Reply" style="width:120px;height:35px;margin-left:500px;vertical-align:top;"  /></li>
