...
color: aqua;
		...
		.content{ padding:10px 10px 30px; width:920px; margin:0 auto; background-color:#ffffff; position:relative; }
			...
			.menu2{ right:10px; left:auto; background-color:#f1f1f1; width:560px; height:100px; }
	...
	<div class="content">
		<div class="menu" sytle="padding-top:300px">
			<?php
					...
					?>
					<b style="color:#000000;font-size:15px">Choosen Category</b><br><br>			
					<b style="color:#ff0000;font-size:15px"><?php echo $prdt; ?></b>	
						...
						<b style="color:#0fff00;font-size:15px">&nbsp:&nbsp</b>
						<b style="color:#006699;font-size:15px"><?php echo $subprdt; ?></b><br><br>
						<hr>
						<?php
						}
						...
						?>
						<b style="color:#000000;font-size:15px">States</b>
					...
					<hr>
					<b style="color:#000000;font-size:15px">Price Range</b><br><br>	
					
					
					<?php
					$ipstate=$startprice=$endprice=$startquantity=$endquantity=$ipquantity=null;
					
					
					//setters for all the variables
					if(isset($_POST['state1']))
					{
						$ipstate=$_POST['state1'];
						//echo $pageNum;
					}	
					...
					$startquantity = $_POST["minquantity"]; // sender
					$endquantity = $_POST["maxquantity"];
					$ipquantity = $_POST["quantity"];
					}
					...
					if(isset($_GET['firstprice']))
					{
					$startprice = $_GET['firstprice']; 
					$endprice = $_GET['lastprice'];		
					}	
					
					if(isset($_GET['firstquantity']))
					{
					$startquantity = $_GET['firstquantity']; 
					$endquantity = $_GET['lastquantity'];	
					$ipquantity = $_GET["quantity"];
					}	
				...
				<input type="text"  name="minprice" style="width:80px;height:30px" data-validetta="required,minLength[2],maxLength[30]" class="txtinput" /> 
					<b style="color:#006699;font-size:15px">-</b>
				...
				<b style="color:#000000;font-size:15px">Quantity Range</b><br><br>	
					...
					print '<form    method="post" action="'.$self.'? to_id2='.$prdt.' & to_id='.$subprdt .' & state='.$ipstate.' & firstprice='.$startprice.' & lastprice='.$endprice.' ">';


					?>	
								
				<input type="text"  name="minquantity" style="width:120px;height:30px" data-validetta="required,minLength[2],maxLength[30]" class="txtinput" /> 
					<b style="color:#006699;font-size:15px">&nbsp&nbsp&nbsp-&nbsp&nbsp&nbsp</b>
					<input type="text"  name="maxquantity" style="width:120px;height:30px"   data-validetta="required,minLength[2],maxLength[30]" class="txtinput" /> <br><br>
					
				<select name="quantity" id="price"  class="txtinput1">
				...
				<input type="submit" name="View" Value="View" style="width:80px;height:38px;margin-left:100px">				
				</form>
				<?php
		...
		<div class="wrap" style="width:550px;margin-top:120px;">		
			<div class="addisplay">
				...
				<?php
					 ...
					 {
						?>
					<img src="<?php echo $pic1; ?>" height='150' width='150' >					
					<?php
					}
					 else
					 {
					...
					if($num_rows == null)
					{
					Print "<b style='color:#ff0000;font-weight:bold;font-size:15px'>";
